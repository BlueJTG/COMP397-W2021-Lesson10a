...
public class ControlPanelController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Deserialize and loading our Data from Player Preferences - What we would like to do
    ...
    public void OnSaveButtonPressed()
    {
        ...
        // Serialize and Save our data to Player Preferences dictionary/db - what we wouldl like to do
